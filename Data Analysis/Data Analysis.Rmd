...
The first Quantile-Quantile Plots and the second Quantile-Quantile Plots both show an extremely unequal distribution of R&D personnel. Wihle both populations (see each graph) have some outliers extremely far away, the majority of Quantiles can be founds near 0. When comparing the first population with the second, it can be seen that the first graph shows much more density around 0.
**</span>
...
The boxplot for the distribution of R&D personnel shows a wider distribution of personnel for non-participants of the incubator. FOr these, the median is on two for R&D personnel. For Incubator participants, the distribution is much more focused with a median around 1 R&D personnel for both the non-log and log-based boxplot.
