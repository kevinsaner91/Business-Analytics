...
test = aggregate(dataset$D5, by=list(dataset$D9IncYes1), FUN="qqnorm", na.action = na.omit, main="Quantile-Quantile Plots", xlab=c("Participants","Non-Participants"), ylab="R&D Personel")
#boxplot(test$x[1,]$y, test$x[2,]$y, names = c("No", "Yes"))

# Boxplot outliers are not drawn
boxplot(test$x[1,]$y, test$x[2,]$y, names = c("No-Participant", "Participant"), outline=FALSE, main="R&D personell distribution")
...
plot(x=factorvar, y=dataset$D5, names = c("No-Participant", "Participant"), outline=FALSE, main="R&D personell distribution")
