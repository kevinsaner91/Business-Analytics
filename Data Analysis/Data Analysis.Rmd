...
*Create a Quartile-Quartile Plot to compare the R&D personnel of incubator and non-participants.*
...
We are using the boxplot to further enable us to show the strong focus on lower number of R&D personnel. Again we are drawing the outliers for both non-log and logbased boxplots, as we are interested in visualising the outliers.
