...
dataset_D4_D9IncYes1$D9IncYes1[which(!is.na(dataset_D4_D9IncYes1$D9IncYes1))]<- "Yes"
...
```{r}
# test for a statistically significant difference between response and non-response
wilcox.test(dataset$D4[which(is.na(dataset$D9IncYes1))],dataset$D4[which(!is.na(dataset$D9IncYes1))])
```
Reject H0, companies that did not respond to D9IncYes1 are bigger.
