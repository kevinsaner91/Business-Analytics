...
# Scenario 1
![Simulation Model for Case 1](./images/Picture1.png){width=250px}
...
# Scenario 2A
![Simulation Model for Case 2A](./images/Picture2.png){width=250px}
...
# Scenario 2B
![Simulation Model for Case 2B](./images/Picture3.png){width=250px}
...
See example C2A with a positive slope for the flow time and A2B with a stable flow time
...
In the following are the plots of the flow time of all models:
